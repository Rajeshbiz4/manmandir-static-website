                  ...
                  <div class="col-md-6">
                     <div class="map_main">
                        <div class="map-responsive">
                           <iframe src="https://www.google.com/maps/embed/v1/place?key=AIzaSyA0s1a7phLN0iaD6-UE7m4qP-z21pH0eSc&amp;q=Shrushti Chowk, Prabhat Nagar, Pimple Gurav, Pimpri-Chinchwad, Maharashtra 411061" width="600" height="360" frameborder="0" style={{border:0, width: '100%'}} allowfullscreen=""></iframe>
                        </div>
                     </div>
                  </div>
               </div>
